...
//Create JWT Token
const createToken = (userId) => {return jwt.sign({id:userId }, JWT_secret, { expiresIn: TOKEN_EXPIRES }) };
...
export async function updatePassword(req, res) {
    ...
    if (!currentPassword || !newPassword || newPassword.length < 8) {
        return res.status(400).json({success:false, message: "Valid Old Password and New Password Required" });
    }
