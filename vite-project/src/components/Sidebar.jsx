...
const Sidebar = ({ user, tasks }) => {
  ...
  useEffect(() => {
    const tips = [
      ...
      "Break tasks into smaller chunks for easier completion",
      "Prioritize tasks using the Eisenhower Matrix",
      "Avoid multitasking — focus on one task at a time",
      "Take short breaks to maintain focus throughout the day",
      "Review and plan your day each morning",
      "Use time blocking to allocate hours to tasks",
            ...
            <div className={TIP_CARD.container}>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className={TIP_CARD.text}>{tip}</p>
                </div>
              </div>
            </div>
          </div>
