...
const Layout = ({onLogout,user}) => {
        ...
        <div className='p-2 sm:p-3 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all duration-300 hover:border-purple-100 group'>
            <div className="flex items-center gap-2">
                <div className="p-1.5 rounded-lg bg-gradient-to-br from-fuchsia-500/10 to-purple-500/10 group-hover:from-fuchsia-500/20 to group-hover:to-purple-500/20">
                {icon}
                </div>
            ...
            <div className='ml-0 xl-ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300'>
                <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'>
                    ...
                    <div className="xl:col-span-1 space-y-4 sm:space-y-6">
                        <div className="bg-white rounded-xl p-4 sm:p-5 shadown-sm border border-purple-100">
                            <h3 className='text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex items-center gap-2'>
                                <TrendingUp className='w-4 h-4 sm:w-5 sm:h-5 text-purple-500 '/>
                                Task Statistics
                            </h3>
                            <div className='grid grid-cols-2 mb-4 sm:gap-4 gap-3 sm:mb-6'>
                                ...
                                <StatCard title="Pending" value={stats.pendingCount} icon={<Circle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-fuschia-500'/>}/>
                            ...
                            <div className='space-y-2 sm:space-y-3 '>
                                <div className='flex items-center justify-between text-gray-700'>
                                    <span className='text-xs sm:text-sm font-medium flex items-center gap-2'>
                                        <Circle className='w-3 h-3 sm:w-4 sm:h-4 text-purple-500 fill-purple-500'/>
                                        Total Progress
                                    </span>
                                ...
                                <div className='relative pt-1'>
                                    <div className='flex gap-1.5 items-center'>
                                        <div className='w-full h-3 sm:h-4 bg-purple-100 rounded-full overflow-hidden'>
                        ...
                        <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                            ...
                            <div className='space-y-2 sm:space-y-3'>
                                {tasks.slice(0,3).map(task => (
                                    <div key={task._id || task.id} className='flex items-center justify-between p-2 sm:p-3 border-transparent hover:border-purple-100 rounded-lg hover:bg-purple-50/50 transition-colors duration-200'>
                                        ...
                                        <span className={`px-2 py-1 text-sm rounded-full shrink-0 ml-2
                                ...
                                {tasks.length === 0 && (
                                    <div className='text-center py-4 sm:py-6 px-2 '>
                                        <div className="w-12 h-12 sm:w-16 sm:h-6 mx-auto sm:mb-4 rounded-full bg-purple-100  flex items-center justify-center">
                                            <Clock className='w-6 h-6 sm:h-8 sm:w-8 text=purple-500'/>
                                        </div>
