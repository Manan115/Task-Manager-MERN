...
import { personalFields, INPUT_WRAPPER } from "../assets/dummy";
import { Save } from "lucide-react";
import axios from "axios";
import { useEffect } from "react";
import { Lock, Shield, LogOut } from "lucide-react";
import { securityFields } from "../assets/dummy";
  ...
  useEffect(() => {
    ...
    if (!token) {
      return axios
        ...
        .catch(() => toast.error("Unanle to Load Profile"));
    }
  }, []);
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <section className={SECTION_WRAPPER}>
            ...
            <form onSubmit={changePassword} className="space-y-4">
              {securityFields.map(({ name, type, placeholder }) => (
                <div key={name} className={INPUT_WRAPPER}>
