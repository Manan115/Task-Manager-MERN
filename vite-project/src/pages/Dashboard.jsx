...
import TaskItem from "../components/TaskItem"; // Adjust the path based on your file structure
import {
  ADD_BUTTON,
  EMPTY_STATE,
  FILTER_LABELS,
...
import { Filter, HomeIcon, Calendar} from "lucide-react";
              ...
              {filteredTasks.length === 0 ? (
                <div className={EMPTY_STATE.wrapper}>
                    <div className={EMPTY_STATE.iconWrapper}>
                      ...
                      <h3 className="text-lg font-semibold text-gray-800 mb2">
                        No Tasks found
                      </h3>
                ...
                filteredTasks.map(task=>(
                  <TaskItem key={task._id || task.id} task={task} onRefresh={refreshTasks} showCompleteCheckbox onEdit={()=>{
